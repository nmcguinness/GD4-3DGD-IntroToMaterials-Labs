...
| ~~Lab 4 – Toon Shading~~ [WORK IN PROGRESS] | ~~Toon lighting, Thresholding, ddx/ddy, Halftone~~ | ~~Creates a stylised cel shader using derivative-based edge masks, thresholded lighting bands, soft transitions, and optional halftone overlays for comic rendering.~~ | ~~[Lab4_ToonShading](Labs/HLSL/Lab4_ToonShading.md)~~ |
